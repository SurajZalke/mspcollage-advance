...
const HostSignupPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-colors duration-1000 ${backgrounds[currentBgIndex]} dark:bg-gradient-to-br dark:from-[#1a1f2c] dark:via-[#31137c] dark:to-[#b09cff]`}>
